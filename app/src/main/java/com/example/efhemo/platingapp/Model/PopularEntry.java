...
@Entity(tableName = "popular", indices = {@Index(value = {"poster_path", "title"}, unique = true)})
public class PopularEntry implements GenericListItem {
    ...
    public PopularEntry(String title, double popularity, String poster_path, double
            vote_average,
    ...
    //
    public PopularEntry(int id, double vote_average, String title, double popularity,
                        String poster_path,
    int ident, int voteCount, boolean videoBoolen,
                        String original_language, String backdrop_path,
                        String overview, String release_date) {
